...
public class LoginActivity extends Activity implements IWeiboActivity{
	...
	public void init() {
		...
		{//联网正常
		 ...
		 //判断用户是否登录过	
			...
			{ //设定WEibo对象的验证访问密钥 
				System.setProperty("weibo4android.oauth.consumerKey", Weibo.CONSUMER_KEY);
	        	System.setProperty("weibo4android.oauth.consumerSecret", Weibo.CONSUMER_SECRET);
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        acUser.setText("sdhjob@hotmail.com");
