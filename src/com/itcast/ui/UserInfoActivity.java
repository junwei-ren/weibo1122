...
public class UserInfoActivity extends Activity implements IWeiboActivity{
...
//		String info=this.getIntent().getData().getPath();
//		this.setContentView(R.layout.userinfo);
//	    TextView tv=(TextView) this.findViewById(R.id.title).findViewById(R.id.textView);
//	    tv.setText(info);}
//	}
	private User user;
	private View title;
